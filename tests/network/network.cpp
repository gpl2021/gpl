...
void * send (bool to_master)
{
    if (to_master) {
        ...
        test_adaptor->send(master_sid, thread_id, "");
    } else {
...
int main(int argc, char *argv[])
{
    ...
    ("power,p", value<int>()->default_value(10)->value_name("<power>"), "set sending message size up to the power of 2");
    ...
    int power = network_vm["power"].as<int>();
